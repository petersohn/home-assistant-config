...
def _state_should_change_at(harness, timing, entity, value, target_time):
...
def _initialize_with_delay(harness, minutes, **args):
...
def _test_delay(harness, timing):
...
def test_availability(harness, timing):
    _initialize_with_delay(harness, 1)
    _test_availability(harness, timing)


def test_availability_with_mode_switch(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    _test_availability(harness, timing)


def _test_temporary_manual_mode(harness, timing):
...
def test_temporary_manual_mode(harness, timing):
    _initialize_with_delay(harness, 1)
    _test_temporary_manual_mode(harness, timing)


def test_temporary_manual_mode_with_mode_switch(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    _test_temporary_manual_mode(harness, timing)


def test_manual_mode_from_stable_to_auto(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    harness.schedule_call_at(timedelta(seconds=30), "set_state", input_entity, 50)
    harness.schedule_call_at(
...
def test_manual_mode_availability_change(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    harness.schedule_call_at(timedelta(seconds=30), "set_state", input_entity, 50)
...
def test_manual_mode_state_change_auto(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    harness.schedule_call_at(timedelta(seconds=30), "set_state", input_entity, 50)
    harness.schedule_call_at(timedelta(minutes=2), "select_option", mode_switch, "manual")
    harness.schedule_call_at(
...
def test_manual_mode_state_change_stable(harness, timing):
    _initialize_with_delay(harness, 1, mode_switch=mode_switch)
    harness.schedule_call_at(timedelta(seconds=30), "set_state", input_entity, 50)
    harness.schedule_call_at(timedelta(minutes=2), "select_option", mode_switch, "manual")
    harness.schedule_call_at(
