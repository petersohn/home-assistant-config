...
def _initialize_services(appdaemon_client):
...
def _initialize(appdaemon_client, history_watcher, *configs):
...
def test_reload_while_stable(appdaemon_client, history_watcher):
    _initialize(appdaemon_client, history_watcher, "Cover1")
...
def test_reload_while_manual(appdaemon_client, history_watcher):
    _initialize(appdaemon_client, history_watcher, "Cover1")
    ...
    assert appdaemon_client.get_state(output_entity) == 0.0